...
variable f5vm01mgmt { default = "10.0.10.5" }
variable f5vm01ext { default = "10.0.30.5" }
variable f5vm01ext_sec { default = "10.90.2.11" }
variable f5vm01int { default = "10.0.20.5"}
variable f5vm02mgmt { default = "10.0.10.6" }
variable f5vm02ext { default = "10.0.30.6" }
variable f5vm02ext_sec { default = "10.90.2.12" }
variable f5vm02int { default = "10.0.20.6"}
